...
from repositories.database_manager import ScraperDatabaseManager
    ...
    def run(self):
        for start_url in self.start_urls:
            ...
            while True:
                ...
                if not self.db_manager.exists_or_changed(url['url'], html_hash):
                    self.db_manager.register_scrape(url['url'], html_hash)
